...
public class SoundHelper {
    ...
    public SoundHelper(AppCompatActivity activity) {
        ...
        mVolume = (float) (audioManager != null ? audioManager.getStreamVolume(AudioManager.STREAM_MUSIC) : 0) /
                (float) (audioManager != null ? audioManager.getStreamMaxVolume(AudioManager.STREAM_MUSIC) : 0);
        ...
        mSoundID = mSoundPool.load(activity, R.raw.candy_sfx, 1);
    }
    ...
    public void prepareMusicPlayer(@NonNull Context context) {
        mMusicPlayer = MediaPlayer.create(context.getApplicationContext(), R.raw.backgorund_music);
